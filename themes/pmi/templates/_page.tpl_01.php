...
<table width="1000" cellspacing="0" cellpadding="0" border="0" align="center">
  ...
  <tr>
  <td>
    <table width="800" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:0 auto;">
      <tbody>
        <tr>
<!--          <td width="7" valign="top" class="bodyLeft"><img width="31" height="40" alt="none" src="themes/pmi/cms/images/headLeft.gif"></td>
-->          
			<td width="770" valign="top" bgcolor="#FFFFFF" align="center" class="mainTable"><div id="header">
              <div class="section clearfix">
                ...
                <div id="mainLinksBar">`
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      <tr>
                      	<td> <?php if (!$user->uid){ ?> <a href="<?php echo($base_path); ?>sitecontent"><img src="<?php echo($base_path); ?>themes/pmi/cms/images/memberLogin.gif" width="100" height="25" style="margin:23px 0 0 150px;"></a> <?php } else  { ?> <a href="<?php echo($base_path);?>/user/<?php echo($user->uid); ?>/edit" class="topNav welcome"> Welcome, <?php echo($user->name); ?> </a> <?php } ?> </td>
                      </tr>
                      <tr>
                        <td valign="bottom" height="25" align="right"><a class="topNav" href="<?php echo($base_path); ?>home"> Home </a> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>news"> News </a> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>newsletter"> Newsletters </a> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>events"> Events </a> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>contact_us"> Contact Us </a> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>sitemap"> Sitemap </a> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>user/register"> Registration </a>  <?php if ($user->uid)  { ?> <span class="txtTopNav"> | </span> <a class="topNav" href="<?php echo($base_path); ?>user/logout"> Logout </a> <?php } ?> </td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div id="main_menu">
                  <table cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      <tr>
                        <td><div id="ChapterDocuments" class="menu"><a href="<?php echo($base_path); ?>#"><img height="35" border="0" width="222" alt="My PMI KPC" src="<?php echo($base_path); ?>themes/pmi/cms/images/headMYPMIKPC.gif"></a></div></td>
          ...
          <td width="750" valign="top" height="75" bgcolor="#FFFFFF" align="left"><div id="footer_panel"><br>
              <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                  ...
                  <tr>
                    <td height="30" align="center" class="tableBlueBorder"><span class="txtFootNav"> <a class="footNav" href="<?php echo($base_path); ?>home"> Home </a> | <a class="footNav" href="<?php echo($base_path); ?>news"> News </a> | <a class="footNav" href="<?php echo($base_path); ?>Documents"> Chapter Documents </a> | <a class="footNav" href="<?php echo($base_path); ?>Membership"> Membership </a> | <a class="footNav" href="<?php echo($base_path); ?>president_and_vice_president"> Board Members </a> | <a class="footNav" href="<?php echo($base_path); ?>Knowledge"> PMI Knowledge </a> | <a class="footNav" href="<?php echo($base_path); ?>Newsletter"> Newsletters </a> | <a class="footNav" href="<?php echo($base_path); ?>events"> Events </a> | <a class="footNav" href="<?php echo($base_path); ?>contact_us"> Contact Us </a> | <a class="footNav" href="<?php echo($base_path); ?>survey"> Survey </a> | <a class="footNav" href="<?php echo($base_path); ?>faqs"> FAQs </a> | <a class="footNav" href="<?php echo($base_path); ?>feedback"> Feedback | </a><a class="footNav" href="<?php echo($base_path); ?>sitemap"> Sitemap </a> </span></td>
                  </tr>
                  <tr>
