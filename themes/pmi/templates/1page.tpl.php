              ...
              <div class="section clearfix">
                ...
                <div id="main_menu">
                  <table cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      <tr>
                        <td><div id="ChapterDocuments" class="menu"><a href="<?php echo($base_path); ?>sitecontent"><img height="35" border="0" width="222" alt="My PMI KPC" src="<?php echo($base_path); ?>themes/pmi/cms/images/headMYPMIKPC.gif"></a><div class="sub_menu">
                                                  <ul style="display: none;" class="red">
                                                        ...
                                                        <li><a href="<?php echo($base_path); ?>election_2010"> Elections</a></li>
                                                        <li><a href="<?php echo($base_path); ?>feedback"> Feedback</a></li>
                                                        <li><a href="<?php echo($base_path); ?>bodarea"> BOD Area</a></li>
                                                  </ul>
                                            </div>
                          </div></td>                        
                        ...
                        <td><div id="Membership" class="menu"><a href="<?php echo($base_path); ?>programs"><img height="35" border="0" width="144" alt="Programs" src="<?php echo($base_path); ?>themes/pmi/cms/images/headPROGRAMS.gif"></a><div class="sub_menu">
